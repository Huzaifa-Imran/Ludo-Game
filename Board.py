...
jailSlots = [[(1.5, 1.5), (3.5, 1.5), (1.5, 3.5), (3.5, 3.5)], [(10.5, 1.5), (12.5, 1.5), (10.5, 3.5), (12.5, 3.5)], [(10.5, 10.5), (12.5, 10.5), (10.5, 12.5), (12.5, 12.5)],  [(1.5, 10.5), (3.5, 10.5), (1.5, 12.5), (3.5, 12.5)]]
...
def tokensClash(colour, number, newPos, pos): #check if there is already a token at current or new position
            for i in range(4):
                for j in range(4):
                    if tokenHoused[i][j] != tokenHoused[colour][number]:
                        continue
